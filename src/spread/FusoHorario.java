 ...
 * fuso horário com uma hora a mais com relação ao fuso horário do ponto de partida, a hora de chegada terá que ser:
...
public class FusoHorario {
    public static void main(String[] args) {
        ...
        System.out.println("Inforsme o horário de Saída: ");
        int horasaida = sc.nextInt();
        System.out.println("Inforsme o tempo de viagem: ");
        int tempoviagem = sc.nextInt();
        System.out.println("Inforsme o fuso horário local: ");
        int fuso = sc.nextInt();

        int ajuste = horasaida + tempoviagem + fuso;
        if (ajuste >= 24) ajuste -= 24;
        else if (ajuste < 0) ajuste += 24;

        System.out.println("Previsão de chegada ao seu destino:\n---" + ajuste + "Hs");
