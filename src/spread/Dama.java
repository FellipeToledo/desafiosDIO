...
public class Dama {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (x1 == x2 && y1 == y2)
                System.out.println("O menor número de movimentos necessário é: 0");
            else if (x1 == x2 || y1 == y2 || Math.abs(x1 - x2) == Math.abs(y1 - y2))

                System.out.println("O menor número de movimentos necessário é: 1");
            else
                System.out.println("O menor número de movimentos necessário é: 2");
        }
        sc.close();
    }
}
